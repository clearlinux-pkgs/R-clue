...
Version  : 0.3.55
Release  : 10
URL      : https://cran.r-project.org/src/contrib/clue_0.3-55.tar.gz
Source0  : https://cran.r-project.org/src/contrib/clue_0.3-55.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1525635070
