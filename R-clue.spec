...
Version  : 0.3.63
Release  : 54
URL      : https://cran.r-project.org/src/contrib/clue_0.3-63.tar.gz
Source0  : https://cran.r-project.org/src/contrib/clue_0.3-63.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669056623
